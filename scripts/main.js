...
define('css!angular-csp',[],function(){});
//Wrapped in an outer function to preserve global this
(function (root) { var amdExports; define('angular',['css!angular-csp'], function () { (function () {
...
define('angular-ui-router',['require','exports','module','angular'],function (require, exports, module) {
   
   // TODO(ewinslow): ui-router is checking for Node-style modules and
   // isn't declaring it's own dependencies, so this breaks volo's AMD wrapping.
   require('angular');
 ...
 */
define('ngRequire/createDirective',[],function() {
 ...
 */
define('ngRequire/Require',['require','ngRequire/createDirective'],function(require) {
...
define('ngRequire/RequireProvider',['require','./Require'],function(require) {
...
define('ngRequire',['require','angular','angular-ui-router','ngRequire/RequireProvider'],function(require) {
...
define('ngRequire/createModule',['require','angular','angular-ui-router','ngRequire'],function(require) {
    var angular = require('angular');
    var uiRouter = angular.module('ui.router');
    require('angular-ui-router');
...
define("json!elgg/accounts/module.json", function(){ return {
	"states": {
		"login2": {
			"controller": true,
			"template": true,
...
define("json!elgg/core/module.json", function(){ return {
	"directives": [
		"elggButton",
		"elggGallery",
		"elggIcon",
...
define('css!snap',[],function(){});
define('angular-snap',['require','exports','module','snap','css!snap','angular'],function (require, exports, module) {
    
    // TODO(ewinslow): local "exports" variable below is breaking volo's
    // heuristics for detecting Node/AMD modules
    require('snap');
    require('css!snap');
    var angular = require('angular');
...
//Wrapped in an outer function to preserve global this
(function (root) { var amdExports; define('angular-translate',['angular'], function () { (function () {
...
define('elgg/core/module',['require','ngRequire/createModule','json!elgg/core/module.json','angular','angular-snap','angular-translate'],function(require) {
...
define('elgg/accounts/module',['require','ngRequire/createModule','json!elgg/accounts/module.json','elgg/core/module'],function(require) {
    var createModule = require('ngRequire/createModule');
...
define("json!elgg/events/module.json", function(){ return {
	"states": {
		"events": {
			"controller": true,
			"parent": "default",
...
define('elgg/events/module',['require','ngRequire/createModule','json!elgg/events/module.json','elgg/core/module'],function(require) {
    var createModule = require('ngRequire/createModule');
...
define("json!elgg/photos/module.json", function(){ return {
	"states": {
		"photos": {
			"controller": true,
			"parent": "default",
...
define('elgg/photos/module',['require','ngRequire/createModule','json!elgg/photos/module.json','elgg/core/module'],function(require) {
    var createModule = require('ngRequire/createModule');
...
define("json!elgg/posts/module.json", function(){ return {
	"states": {
		"posts": {
			"controller": true,
			"parent": "default",
...
define('elgg/posts/module',['require','ngRequire/createModule','json!elgg/posts/module.json','elgg/core/module'],function(require) {
    var createModule = require('ngRequire/createModule');
...
define('main', ['require','angular','elgg/accounts/module','elgg/core/module','elgg/events/module','elgg/photos/module','elgg/posts/module'],function(require) {
    var angular = require('angular');
...
('@charset \"UTF-8\";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none!important}ng\\:form{display:block}.ng-animate-start{border-spacing:1px 1px;-ms-zoom:1.0001}.ng-animate-active{border-spacing:0 0;-ms-zoom:1}html,body{font-family:sans-serif;margin:0;padding:0;width:100%;height:100%;overflow:hidden}.snap-content{position:absolute;top:0;bottom:0;height:auto;z-index:2;overflow:auto;-webkit-overflow-scrolling:touch;-webkit-transform:translate3d(0,0,0);-moz-transform:translate3d(0,0,0);-ms-transform:translate3d(0,0,0);-o-transform:translate3d(0,0,0);transform:translate3d(0,0,0)}.snap-content,.snap-drawers{right:0;left:0;width:auto}.snap-drawers,.snap-drawer{position:absolute;top:0;bottom:0;height:auto}.snap-drawer{right:auto;left:auto;width:265px;overflow:auto;-webkit-overflow-scrolling:touch;-webkit-transition:width .3s ease;-moz-transition:width .3s ease;-ms-transition:width .3s ease;-o-transition:width .3s ease;transition:width .3s ease}.snap-drawer-left{left:0;z-index:1}.snap-drawer-right{right:0;z-index:1}.snapjs-left .snap-drawer-right,.snapjs-right .snap-drawer-left{display:none}.snapjs-expand-left .snap-drawer-left,.snapjs-expand-right .snap-drawer-right{width:100%}');
